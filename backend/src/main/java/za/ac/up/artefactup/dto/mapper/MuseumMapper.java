...
import za.ac.up.artefactup.dto.*;
import za.ac.up.artefactup.entity.*;
...
public interface MuseumMapper {
    ...
    // @AfterMapping
    // protected void mapArtefacts(@MappingTarget Museum museum, MuseumDTO
    // museumDTO) {
    ...
    //
    // @AfterMapping
    // protected void mapOpeningHours(@MappingTarget Museum museum, MuseumDTO
    // museumDTO) {
